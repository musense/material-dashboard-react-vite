...
import { BsTypeH1, BsTypeH2, BsTypeH3, BsCameraVideoFill, BsCode, BsArrowUp, BsArrowDown, BsQuestionCircle, BsCheckCircleFill, BsXCircleFill } from 'react-icons/bs'
...
const iconList = {
  ...
  success: <BsCheckCircleFill size={18} color={'green'} />,
  fail: <BsXCircleFill size={18} color={'red'} />,
}
